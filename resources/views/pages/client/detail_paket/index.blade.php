...
@section('content')
        ...
        <div class="flex justify-center pt-72" style="height: 100vh">
            <div>
                <h1 class="text-center text-white template-h1 font-semibold" data-aos="fade-up" data-aos-duration="1000">
                    Silver Packet</h1>
                <h6 class="text-center text-white mt-6 text-2xl" data-aos="fade-up" data-aos-duration="1500">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate, ab cum.
                </h6>
    ...
    <section class="detail-packet-section pt-20 pb-28">
        <div class="px-96">
            <div class="px-44">
                <div>
                    <h5 class="text-redlue text-center text-xl font-semibold" data-aos="fade-up" data-aos-duration="1000">Silver Packet</h5>
                </div>
                <div class="mt-7">
                    <h2 class="text-redlue text-4xl font-bold text-center" data-aos="fade-up" data-aos-duration="1000">Unlock the Benefits: <br>Elevate Your Wedding Planning <br>with Our Silver Packet!</h2>
                </div>
                <div class="mt-7">
                    <p class="text-redlue text-center text-xl" data-aos="fade-up" data-aos-duration="1000">Experience an unforgettable wedding day with our exclusive package, featuring an attentive crew of 8 dedicated professionals. Enjoy priority planning services starting 12 months in advance, ensuring every detail is tailored to your vision with the guidance of a Professional Wedding Assistant.</p>
                </div>
            </div>
        </div>
        ...
        <div class="px-40 mt-14">
            <div class="grid grid-cols-3 gap-5">
                <div>
                    <img src="{{ asset('asset/image/decoration_placeholder3.jpg') }}" alt="" style="height: 600px; object-fit: cover;" data-aos="fade-up" data-aos-duration="1000">
                </div>
                <div class="mt-12">
                    <img src="{{ asset('asset/image/decoration_placeholder2.jpg') }}" alt="" style="height: 600px; object-fit: cover;" data-aos="fade-up" data-aos-duration="1000">
                </div>
                <div>
                    <img src="{{ asset('asset/image/decoration_placeholder1.jpg') }}" alt="" style="height: 600px; object-fit: cover;" data-aos="fade-up" data-aos-duration="1000">
                </div>
            </div>
            ...
            <div class="grid grid-cols-3 mt-36">
                ...
                <div class="col-span-2 pl-20">
                    <div>
                        <h5 class="text-redlue text-xl font-semibold" data-aos="fade-up" data-aos-duration="1000">Benefits</h5>
                    </div>
                    <div class="mt-7">
            ...
            <div class="mt-36">
                <h2 class="text-redlue text-4xl font-bold text-center" data-aos="fade-up" data-aos-duration="1000">Our Galleries</h2>
    ...
    <section class="hero-bottom relative">
        <div class="flex justify-center items-center" style="height: 65vh">
            <div>
                <h6 class="text-center text-white mt-6 text-2xl" data-aos="fade-up" data-aos-duration="1500">Simplified The Preparation of Your Special Day
                </h6>
                <h1 class="text-center text-white template-h1 font-semibold" data-aos="fade-up" data-aos-duration="1000">
                    Book Silver Packet</h1>
                    <div class="flex justify-center mt-3">
                        <a href="" class="text-white rounded-3xl px-7 py-3 book-btn"
