    ...
    <section class="about-us-section relative" style="background-color: #f7f0f0">
        <div class="px-40 py-24">
            ...
            <div class="px-80 mt-10">
                <p class="text-redlue font-semibold text-2xl text-center" data-aos="fade-up" data-aos-duration="1500">“At Lovify, we believe every love story deserves to be celebrated in a way that is as unique and beautiful as the couple at its heart. What started as a passion for curating unforgettable moments has blossomed into a full-fledged wedding planning service, trusted by couples to bring their dream weddings to life.”</p>
            </div>
            ...
            <div class="grid grid-cols-3 mt-40">
                ...
                <div class="pl-14 col-span-2">
                    ...
                    <div class="pr-52">
                        <p class="text-redlue font-semibold text-2xl mt-16" data-aos="fade-up" data-aos-duration="1500">We understand that no two couples are the same, and neither should their weddings be. Our personalized approach ensures that every detail is thoughtfully designed to reflect your personality, style, and love story. Whether you're envisioning an intimate ceremony or a grand celebration, we’re here to help you create a day that will leave a lasting impression for years to come.</p>
                    </div>
                </div>
            </div>

            <div class="mt-40 pb-10 px-64">
                <p class="text-redlue font-semibold text-2xl mt-16 text-center" data-aos="fade-up" data-aos-duration="1500">“What sets us apart is our commitment to understanding your needs, guiding you through every step, and handling the details so you can focus on what truly matters : celebrating your love. We don’t just plan weddings; we create memories that last a lifetime.”</p>
            </div>
