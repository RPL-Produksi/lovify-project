...
@section('content')
    <section class="hero-section relative">
        <div class="flex justify-center items-center" style="height: 100vh">
            <div>
                ...
                <h3 class="text-center text-white template-h3" data-aos="fade-up" data-aos-duration="1500"
    ...
    <section class="service-section py-20" id="service-section" style="background-color: #f7f0f0">
        <div class="box-section px-5">
            <h1 class="template-h1 font-semibold text-redlue" data-aos="fade-up" data-aos-duration="1000">Our Services</h1>
    ...
    <section class="about-section pt-10 pb-20" id="about-section" style="background-color: #f7f0f0">
        <div class="px-40">
            <div class=" grid grid-cols-2" style="display: flex; justify-content: space-between;">
                <div class="text-a">
                ...
                <div class="grid grid-cols-2 justify-items-center b gap-5" style="width: 620px;">
...
<div class="swiper swiperone">
    ...
    <div class="swiper-wrapper">
      <!-- Slides -->
      <div class="swiper-slide"><img src="{{ asset('asset/image/decoration_placeholder1.jpg') }}" alt=""></div>
      <div class="swiper-slide"><img src="{{ asset('asset/image/decoration_placeholder2.jpg') }}" alt=""></div>
      <div class="swiper-slide"><img src="{{ asset('asset/image/decoration_placeholder3.jpg') }}" alt=""></div>
      <div class="swiper-slide"><img src="{{ asset('asset/image/decoration_placeholder4.jpg') }}" alt=""></div>
      <div class="swiper-slide"><img src="{{ asset('asset/image/decoration_placeholder5.jpg') }}" alt=""></div>
    </div>
