...
@section('content')
    ...
    <div class="cart-section md:px-40 px-4 py-32">
        <div class="md:grid grid-cols-9 gap-5">
            <div class="col-span-5">
                <div>
                    <h2 class="text-redlue font-bold text-2xl md:mb-0 mb-4">Order {{ $order->planning->title }}</h2>
                    <a href="{{ route('client.order.progres', $order->id) }}" class="font-medium bg-rose text-white md:hidden p-2 rounded-md">Order Progress</a>
                    <div class="border-rose pt-8 pb-20 px-7 shadow-2xl md:mt-3 mt-4">
            ...
            <div class="col-span-4 md:mt-0 mt-10">
                <div class="md:flex justify-between">
                    <h2 class="text-redlue font-bold text-2xl md:mb-0 mb-4">Payment Summary</h2>
                    <a href="{{ route('client.order.progres', $order->id) }}" class="hidden md:flex font-medium bg-rose text-white p-2 rounded-md">Order Progress</a>
                    @if ($isPaid)
                    @endif
                </div>
                <div class="border-rose w-100 pt-8 pb-20 px-7 shadow-2xl md:mt-3 mt-5">
                    <div class="mt-5">
